(function (global, factory) {
  ...
  var properties = Object.keys(alternativeProps$1).concat(otherProps);
  ...
  function grabCursor(property, value, style, _ref) {
    ...
    if (property === 'cursor' && values$1[value] && (browserName === 'firefox' || browserName === 'chrome' || browserName === 'safari' || browserName === 'opera')) {
      return getPrefixedValue(cssPrefix + value, value, keepUnprefixed);
    }
  }
  ...
  function gradient(property, value, style, _ref) {
    ...
    if (typeof value === 'string' && value.match(values$2) !== null && (browserName === 'firefox' && browserVersion < 16 || browserName === 'chrome' && browserVersion < 26 || (browserName === 'safari' || browserName === 'ios_saf') && browserVersion < 7 || (browserName === 'opera' || browserName === 'op_mini') && browserVersion < 12.1 || browserName === 'android' && browserVersion < 4.4 || browserName === 'and_uc')) {
      return getPrefixedValue(cssPrefix + value, value, keepUnprefixed);
    }
  }
  ...
  function sizing(property, value, style, _ref) {
    ...
    // Keep an eye on it
    if (properties$1[property] && values$3[value]) {
      return getPrefixedValue(cssPrefix + value, value, keepUnprefixed);
    }
  }
  ...
  function zoomCursor(property, value, style, _ref) {
    ...
    if (property === 'cursor' && values$4[value] && (browserName === 'firefox' && browserVersion < 24 || browserName === 'chrome' && browserVersion < 37 || browserName === 'safari' && browserVersion < 9 || browserName === 'opera' && browserVersion < 24)) {
      return getPrefixedValue(cssPrefix + value, value, keepUnprefixed);
    }
  }

  var plugins = [position, calc, imageSet, crossFade, filter, grabCursor, zoomCursor, sizing, gradient, transition, flexboxIE, flexboxOld, flex];
  ...
  function calc$1(property, value) {
  ...
  function cursor(property, value) {
    if (property === 'cursor' && values$5[value]) {
  ...
  function flex$1(property, value) {
    if (property === 'display' && values$6[value]) {
  ...
  function flexboxIE$1(property, value, style) {
    if (alternativeProps$2[property]) {
      style[alternativeProps$2[property]] = alternativeValues$2[value] || value;
    }
  }
  ...
  function flexboxOld$1(property, value, style) {
    ...
    if (alternativeProps$3[property]) {
      style[alternativeProps$3[property]] = alternativeValues$3[value] || value;
    }
  }

  var prefixes$4 = ['-webkit-', '-moz-', ''];
  var values$7 = /linear-gradient|radial-gradient|repeating-linear-gradient|repeating-radial-gradient/;

  function gradient$1(property, value) {
    if (typeof value === 'string' && !isPrefixedValue(value) && value.match(values$7) !== null) {
  ...
  function sizing$1(property, value) {
    if (properties$3[property] && values$8[value]) {
  ...
  var plugins$1 = [position$1, calc$1, imageSet$1, crossFade$1, filter$1, cursor, sizing$1, gradient$1, transition$1, flexboxIE$1, flexboxOld$1, flex$1];

  var fallback = createPrefixer$1(propertyPrefixMap$1, plugins$1);

  var index = createPrefixer(propertyPrefixMap, plugins, fallback);
