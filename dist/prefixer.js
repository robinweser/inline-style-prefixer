...
var Prefixer = (function () {
  ...
  function Prefixer() {
    ...
    if (userAgent === '*') {
      ...
      this._browserInfo.browsers.forEach(function (browser) {
        var data = _caniuseData2['default'][browser];
        if (data) {
          assign(_this._requiresPrefix, data);
        }
      });
