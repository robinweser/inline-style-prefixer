...
},{"./plugins/cursor":4,"./plugins/flex":5,"./plugins/flexboxIE":6,"./plugins/flexboxOld":7,"./plugins/gradient":8,"./plugins/sizing":9}],2:[function(require,module,exports){
'use strict';
...
var Prefixer = (function () {
  ...
  function Prefixer() {
    ...
    var keepDefaults = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];

    _classCallCheck(this, Prefixer);

    this._userAgent = userAgent;
    this._keepDefaults = keepDefaults;
    this._browserInfo = (0, _utilsGetBrowserInformation2['default'])(userAgent);
      ...
      Object.keys(styles).forEach(function (property) {
        ...
        if (value instanceof Object) {
          ...
          _Plugins2['default'].forEach(function (plugin) {
            (0, _utilsAssign2['default'])(styles, plugin(property, value, _this2._browserInfo, styles, _this2._keepDefaults, false));
          });
        }
      });
...
exports['default'] = function (property, value, _ref2, styles, keepDefaults, forceRun) {
  ...
  if (property === 'cursor' && values.indexOf(value) > -1 && (forceRun || browser === 'firefox' && version < 24 || browser === 'chrome' && version < 37 || browser === 'safari' && version < 9 || browser === 'opera' && version < 24)) {
    return _defineProperty({}, property, prefix.CSS + value + (keepDefaults ? ';' + property + ':' + value : ''));
  }
};
...
exports['default'] = function (property, value, _ref3, styles, keepDefaults, forceRun) {
  ...
  if (properties.indexOf(property) > -1 && (forceRun || (browser === 'ie_mob' || browser === 'ie') && version == 10)) {
    ...
    if (alternativeValues[value]) {
      return _defineProperty({}, property, alternativeValues[value] + (keepDefaults ? ';' + property + ':' + value : ''));
    }
  }
};
...
module.exports = exports['default'];
},{"bowser":15}],13:[function(require,module,exports){
'use strict';
