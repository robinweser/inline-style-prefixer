...
describe('Dynamic Prefixer', () => {
  ...
  describe('Running on android < 4.4', () => {
    ...
    it('should use the chrome version if its chrome to check for required props', () => {
      ...
      expect(andPrefixer._browserInfo.browserVersion).to.eql(47)
    })
    it('Should use firefox version on android 4.2.2', () => {
      const andPrefixer = new Prefixer({ userAgent: Android4_2_2Firefox48 })
      expect(andPrefixer._browserInfo.osVersion).to.eql(4.2)
      expect(andPrefixer._browserInfo.browserVersion).to.eql(48)
    })
  })
  ...
  describe('Running on cordova ios <= 8.4', () => {
    it('should be prefixed if the version is missing', () => {
      ...
      expect(cdv8_4Prefixer._browserInfo.browserVersion).to.eql(8)
    })
  })
  ...
  describe('Prefixing transitions', () => {
    ...
    it('should keep unprefixed properties', () => {
      ...
      const prefixed2 = { transitionProperty: '-webkit-appearance,appearance' }
      expect(
        new Prefixer({
          userAgent: Chrome45,
          keepUnprefixed: true,
  ...
  describe('Evaluating unsupported browsers', () => {
    it('should set a fallback flag', () => {
      expect(new Prefixer({ userAgent: SeaMonkey })._useFallback).to.eql(true)
    })
  })
